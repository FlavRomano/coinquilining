<script lang="ts">
	...
	const shoppingList: ShoppingListItem[] = [
		{ id: "fakeId0", owner_id: "someUUID1", item: "Carote" },
		{ id: "fakeId1", owner_id: "someUUID0", item: "Cipolle" },
		{ id: "fakeId2", owner_id: "someUUID1", item: "Sedano" },
	];
	const listName: string = "Penny market";
</script>
