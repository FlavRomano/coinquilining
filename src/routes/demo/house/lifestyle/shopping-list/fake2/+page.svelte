<script lang="ts">
	...
	const shoppingList: ShoppingListItem[] = [
		{ id: "fakeId0", owner_id: "someUUID1", item: "Fusilli" },
		{ id: "fakeId1", owner_id: "someUUID0", item: "Pesto" },
		{ id: "fakeId2", owner_id: "someUUID1", item: "Bocconcini di pollo" },
	];
	const listName: string = "Lidl";
</script>
...
<div class="text-sm breadcrumbs">
	<ul>
		...
		<li>
			<a href="/demo/house/lifestyle/shopping-list">Shopping-lists</a>
		</li>
		<li>{listName}</li>
	</ul>
</div>

<ShoppingInput {roommates} demo={true} />
<ShoppingTable table={shoppingList} {roommates} demo={true} />
